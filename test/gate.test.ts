...
const perCall = { approvalMode: 'per-call' as const }
const armMode = { approvalMode: 'arm' as const }
...
describe('intranet approval gate', () => {
  ...
  it('always asks before arming under the ask policy', () => {
    assert.deepEqual(gateAction('intranet_arm', perCall, false), { kind: 'ask-arm' })
